...
GLStateEGL::gotValidSurface()
{
	...
	EGLint pAttr[] = {EGL_WIDTH, 800, EGL_HEIGHT, 600, EGL_NONE};
	/*EGLint pAttr[] = {EGL_WIDTH, 640, EGL_HEIGHT, 640, EGL_NONE};*/
    egl_surface_ = eglCreatePbufferSurface(egl_display_, egl_config_, pAttr);//eglCreateWindowSurface(egl_display_, egl_config_, native_window_, 0);
    //egl_surface_ = eglCreateWindowSurface(egl_display_, egl_config_, native_window_, 0);
//    egl_surface_ = eglCreateWindowSurface(egl_display_, egl_config_, NULL, 0);
    if (!egl_surface_) {
