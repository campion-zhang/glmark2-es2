...
//printf("end to clear ----------------\n");
    ...
    std::string name1 = "glmark1.bmp";
    //canvas_.write_to_file(name1);
    scene_->draw();
//printf("end to scene->draw()----------------\n");
    scene_->update();
//printf("end to scene->update()----------------\n");

    std::string name2 = "glmark2.bmp";
    //canvas_.write_to_file(name);
    canvas_.update();
//printf("end to canvas->update()----------------\n");
    //exit(0);
}
